...
```0 */1 * * * export PATH="$HOME/.cargo/bin:$PATH" && /usr/bin/python3 /home/near/nearcore-updater/nearcore-updater.py betanet /home/near/nearcore > /tmp/nearcore-updater-cron.log 2>&1```
...
```0 */1 * * * export PATH="$HOME/.cargo/bin:$PATH" && /usr/bin/python3 /home/near/nearcore-updater/nearcore-updater.py testnet /home/near/nearcore False > /tmp/nearcore-updater-cron.log 2>&1```
